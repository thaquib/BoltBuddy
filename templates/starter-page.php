...
<body class="starter-page-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column justify-content-between">
    ...
    <div class="header-top">
      ...
      <a href="index.html" class="logo d-flex align-items-center justify-content-center">
        ...
        <!-- <img src="/templates/assets/img/logo.webp" alt=""> -->
        <h1 class="sitename">Bolt Buddy</h1>
      </a>
  ...
  <footer id="footer" class="footer light-background">
    <div class="container">
      ...
      <div class="container">
        <div class="copyright">
          <span>Copyright</span> <strong class="px-1 sitename">Bolt Buddy</strong> <span>All Rights Reserved</span>
        </div>
        <div class="credits">
  ...
  <script src="/templates/assets/vendor/typed.js/typed.umd.js"></script>
